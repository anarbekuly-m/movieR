...
CRUD for Movies and Categories

Uploading & serving movie posters

Permissions & access control

Nested serializers & dynamic fields

Full serializer validation

Optimized SQL queries (select_related, prefetch_related)

Class-Based Views (ListAPIView, RetrieveAPIView, CreateAPIView, etc.)

PostgreSQL as the main database

Media storage inside project (movies/media)
